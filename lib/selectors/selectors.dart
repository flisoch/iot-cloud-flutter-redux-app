...
List<Device> devicesSelector(AppState state) => state.devices;

bool isLoadingSelector(AppState state) => state.isLoading;

Device selectedDeviceSelector(AppState state) => state.selectedDevice;

Optional<Device> deviceSelector(List<Device> devices, String id) {
  try {
    return Optional.of(devices.firstWhere((device) => device.id == id));
  } catch (e) {
